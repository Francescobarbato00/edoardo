...
import { FaReact, FaNodeJs, FaHtml5, FaCss3Alt, FaJs, FaGitAlt, FaDocker, FaAws, FaPython, FaJava, FaFigma, FaLinux } from 'react-icons/fa';
        ...
        <div className="text-center md:text-left">
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 gap-6">
            {icons.map((Icon, index) => (
              ...
              >
                <div className="flex items-center justify-center bg-gray-100 text-yellow-500 rounded-lg shadow-md w-20 h-20">
